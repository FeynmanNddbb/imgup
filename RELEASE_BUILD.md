...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\build-release.ps1 -Version 1.0.0
```
...
- `imgup-windows-x64-v1.0.0.exe`: single-file Windows app for direct GitHub Release downloads
- `imgup-windows-x64-v1.0.0.zip`: zip package with the app, license, and usage notes
